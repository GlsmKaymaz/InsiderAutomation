...
public class AmazonTest extends BasePage {
    ...
    public void goToAmazonPageAndAddProduct() {
        ...
        urun.click();
//        Methods.scrollToWebElement(getProductPage().samsungProduct);
//        Methods.wait(4);
//        WebElement dinamikUrun = getProductPage().samsungProduct;
//        dinamikUrun.click();
//        System.out.println("5.satir 1.siradaki urun" + dinamikUrun.getText());
